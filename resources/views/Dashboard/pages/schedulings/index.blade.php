...
<div class="p-6 bg-white rounded-lg shadow">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <x-button.can permission="buat.penjadwalan">
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 mb-4">
        ...
        <div class="flex items-center gap-2">
            <!-- Search Box -->
            <div class="relative">
                <input id="searchBox" type="text" placeholder="Cari jadwal..."
            ...
            <div class="flex items-center gap-2 relative">
                <div class="relative inline-block text-left">
                    <button id="btnFilter"
                        class="flex items-center gap-1 px-3 py-2 text-sm text-gray-600 bg-white border rounded-full shadow-sm hover:bg-gray-50">
                    ...
                    <div id="filterDropdown"
                        class="hidden absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg z-20">
                    </div>
                </div>
            ...
            <tr class="even:bg-gray-50 hover:bg-blue-50 transition-colors">
                ...
                <td class="px-4 py-3 text-center border">
                    <div class="relative inline-block text-left">
                        ...
                        <div id="dropdown-{{ $schedule->id }}" class="hidden absolute right-0 mt-2 w-44 bg-white rounded-lg shadow-lg ring-1 ring-gray-200 z-20">
                            <ul class="py-1 text-sm text-gray-700 divide-y divide-gray-100">

                                {{-- Lihat --}}
                                @can('liat.dokumentasi', $schedule)
                                    <li>
                                ...
                                @can('buat.dokumentasi', $schedule)
                                    <li>
                                        ...
                                        @else
                                            ...
                                            class="flex items-center gap-2 px-4 py-2 hover:bg-gray-50">
                                                <i class="bi bi-camera text-green-500"></i> Dokumentasi
                                            </a>
                                        @endif
                                    </li>
                                @endcan
                                ...
                                {{-- Hapus --}}
                                @can('hapus.penjadwalan', $schedule)
                                    <li>
                                        <form action="{{ route('schedulings.destroy', $schedule->id) }}"
                                            method="POST"
